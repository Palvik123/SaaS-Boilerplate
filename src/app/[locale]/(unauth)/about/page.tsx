        ...
        <div className="space-y-6">
          <div className="border-l-4 border-blue-500 pl-4">
            <h3 className="font-semibold text-lg mb-2">
              Конференция МГУ (24.06.2025)
            </h3>
            <p className="text-gray-700 dark:text-gray-300">
              Доклад: "Интерпретируемый машинный скоринг технологических проектов для венчурных фондов"
            </p>
          </div>
          <div className="border-l-4 border-blue-500 pl-4">
            <h3 className="font-semibold text-lg mb-2">
              Конференция ИГСУ РАНХиГС (13.12.2024)
            </h3>
            <p className="text-gray-700 dark:text-gray-300">
              Доклад на конференции "Государственное управление и развитие России: вызовы, стратегии и перспективы"
            </p>
          </div>
        </div>
      </section>
